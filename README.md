# entity_readiness_baseline_analyst

**Category:** 08-executive-productivity
**Source:** entity-readiness-baseline-analyst.md
...
1. Clone this repository:
   ```bash
   git clone https://github.com/diamitani/entity_readiness_baseline_analyst-skill.git
   ```
...
2. Import the skill into your agent framework:
   ...
   # For Hermes Agent
   skill_view(name='entity_readiness_baseline_analyst')
   ```
